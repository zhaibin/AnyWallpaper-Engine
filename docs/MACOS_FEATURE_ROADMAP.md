...
| 功能模块 | Windows | macOS | 差距 | 状态 |
|---------|---------|-------|------|------|
| **交互模式** | ✅ | ✅ | 0% | ✅ v2.6.0 已实现 |
| **全局鼠标钩子** | ✅ | ✅ (原生) | 0% | ✅ v2.6.0 已实现 |
| **全局键盘监听** | ✅ | ❌ | 5% | ⚠️ 需要权限（可选） |
| **本地文件服务器** | ✅ | ✅ | 0% | ✅ v2.7.0 已实现 |
| **轮询备份机制** | ✅ | N/A | 0% | ✅ macOS 不需要 |

**总体功能完整度**：85% → **95%** ✅ (v2.7.0)
