...
### ✅ Debug 版本
- 路径: `example/build/windows/x64/runner/Debug/anywallpaper_engine_example.exe`
- 大小: ~较大（包含调试符号）
- 用途: 开发调试，控制台输出日志

### ✅ Release 版本
- 路径: `example/build/windows/x64/runner/Release/anywallpaper_engine_example.exe`
- 大小: ~较小（优化编译）
- 用途: 生产环境，性能优化
...
└── build/
    └── windows/
        └── x64/
            └── runner/
                ├── Debug/
                │   ├── anywallpaper_engine_example.exe  ← Debug 可执行文件
                │   ├── flutter_windows.dll
                │   ├── anywallpaper_engine_plugin.dll
                │   └── data/
                └── Release/
                    ├── anywallpaper_engine_example.exe  ← Release 可执行文件
                    ├── flutter_windows.dll
                    ├── anywallpaper_engine_plugin.dll
                    └── data/
```
