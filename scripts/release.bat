...
copy "%PROJECT_ROOT%\windows\anywp_engine_plugin.cpp" "%PACKAGE_DIR%\windows\src\"
copy "%PROJECT_ROOT%\windows\anywp_engine_plugin.h" "%PACKAGE_DIR%\windows\src\"
