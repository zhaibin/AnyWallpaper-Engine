...
describe('Drag handler module', () => {
    ...
    describe('makeDraggable', () => {
        ...
        test('should load persisted position', (done) => {
            ...
            Storage.load = jest.fn((_anyWP, _key, callback) => {
                callback(savedPos);
            });
        ...
        test('should attach mouse event handler', () => {
            DragHandler.makeDraggable(mockAnyWP, mockElement);
            expect(mockElement.__anyWP_dragHandler).toBeDefined();
            expect(mockElement.__anyWP_dragHandler.handleGlobalMouse).toBeInstanceOf(Function);
        });
    });
    describe('removeDraggable', () => {
        ...
        test('should remove event listener', () => {
            ...
            expect(mockElement.__anyWP_dragHandler).toBeDefined();
            DragHandler.removeDraggable(mockAnyWP, mockElement);
            expect(mockElement.__anyWP_dragHandler).toBeUndefined();
        });
