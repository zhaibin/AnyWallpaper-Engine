...
**推荐：预编译包**（最简单集成）
```
anywp_engine_v2.1.5_precompiled.zip
```

**可选：源码包**（需要自定义修改）
```
anywp_engine_v2.1.5_source.zip
```
...
2. **解压新版本**：
   ```bash
   # 解压 anywp_engine_v2.1.5_precompiled.zip 到 packages\
   ```
...
- [ ] 下载预编译包 (`anywp_engine_v2.1.5_precompiled.zip`)
