...
echo ==============================================
echo  AnyWP Engine v1.3.0 Precompiled Package Installer
echo ==============================================
echo.
...
if not exist "pubspec.yaml" (
    ...
    echo    Example: flutter_project\packages\anywp_engine_v1.3.0\setup_precompiled.bat
    echo.
    pause
    exit /b 1
)
...
set "TARGET_DIR=%PACKAGES_DIR%\anywp_engine_v1.3.0"

echo [2/4] Syncing precompiled package to packages/anywp_engine_v1.3.0 ...
if exist "%TARGET_DIR%" (
...
echo.
echo ==============================================
echo AnyWP Engine v1.3.0 precompiled package installed successfully
echo ==============================================
echo.
echo Usage:
...
echo    dependencies:
echo      anywp_engine:
echo        path: ./packages/anywp_engine_v1.3.0
echo.
